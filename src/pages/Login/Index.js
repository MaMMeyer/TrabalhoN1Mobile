...
export default function Login({ navigation }) {
  ...
  // codigo de chamada da foto
  // <StatusBar color="white" backgroundColor={"#193f4d"/* cor do cabeçalho */}/>
  // { keyboard ? null : 
  //   <Topo />
  // }
  ...
  return (
    <KeyboardAvoidingView
      ...
      style={{ flex: 1, backgroundColor: "#193f4d" }/* cor do Fundo */}
      scrollEnabled={true}
...
<Text style={styles.LabelPadrao}></Text>
<Text style={styles.LabelPadrao}></Text>
          ...
          {keyboard ? null :
            <View style={styles.footer}>
              ...
              <View><Text style={styles.txtRodape2}>Trabalho N1</Text></View>
            </View>
          }
        </Container>
